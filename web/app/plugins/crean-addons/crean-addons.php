<?php
/**
 * Plugin Name:       crean Addons
 * Description:       Addons for the crean website
 * Version:           1.0.0
 * Author:            Andrej Cremoznik
 * Author URI:        https://keybase.io/andrejcremoznik
 * Text Domain:       crean-addons
...
class crean_Addons {
  ...
  public function taxonomies() {
    register_taxonomy('thing', ['post-type'], [
      'labels'          => [
        'name'          => __('Things', 'crean-addons'),
        'singular_name' => __('Thing', 'crean-addons')
      ],
      'hierarchical'    => true,
      'public'          => true,
      'rewrite'         => false
  ...
  */
  ...
  public function post_types() {
    register_post_type('thing', [
      ...
      'has_archive'         => true,
      'rewrite'             => ['slug' => __('thing', 'crean-addons')]
    ]);
  }
  */
...
register_activation_hook(__FILE__, ['crean_Addons', 'activate']);
register_deactivation_hook(__FILE__, ['crean_Addons', 'deactivate']);

// Run plugin
function run_crean_addons() {
  $plugin = new crean_Addons();
  $plugin->run();
}
run_crean_addons();
